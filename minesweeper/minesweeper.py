...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Deletes sentences in knowledge whose cells size is 0, as they're useless
        li = [sentence for sentence in self.knowledge if len(sentence.cells) > 0]
        self.knowledge = li
    ...
    def update_safes_and_mines(self):
        ...
        # Check every sentence in knowledge and mark new mines or safe spots if it's the case.
         for sentence in self.knowledge:
    ...
    def subset_inference(self): 
        ...
        # to_append will save pendant new inferred subsets (using subset method), as appending such subsets to knowledge while iterating knowledge may result in errors
        to_append = []
        for sentence in self.knowledge:
            for sentence2 in self.knowledge:
                ...
                if sentence.cells < sentence2.cells:
                    ...
                    to_append.append(Sentence(new_set, new_count))
                elif sentence2.cells < sentence.cells:
                    new_set = sentence.cells - sentence2.cells
                    new_count = sentence.count - sentence2.count
                    to_append.append(Sentence(new_set, new_count))
        for sentence in to_append:
